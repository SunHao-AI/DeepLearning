...
if __name__ == '__main__':
    writer = SummaryWriter("../logs/p2")
    # 读取一张图片
    image_path = "../../DataSet/dataset/train/ants/0013035.jpg"
    ...
    writer.add_image("ant1", image_array, 0, dataformats="HWC")

    # 读取文件夹内所有图片
    from p1_get_data import MyData
    #
    ants_path = MyData("../../DataSet/dataset/train", "ants")
